     ...
     <div style={{display: `${Call("/contact") ? "none" : "flex"}`}} className="Navigation G-flex-between">
       ...
       <div className="buttonsBlock G-alignItems-center">
         <div style={{
           ...
           <div onClick={() => {
             setMenuBar(prev => !prev);
           }} style={{display: `${menuBar ? "block" : "none"}`, borderColor: `${Call("/") ? menuBarColor ? "white" : "black" : Call("/home") ? menuBarColor ? "white" : "black" : "black"}`}} className="menu G-flex-column">
             ...
             <Link onClick={() => {
                 ...
                 <div className="arrow">
                   <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <g id="arrow-narrow-right">
                       <path id="Solid" d="M14.7071 5.29289C14.3166 4.90237 13.6834 4.90237 13.2929 5.29289C12.9024 5.68342 12.9024 6.31658 13.2929 6.70711L17.5858 11H4C3.44772 11 3 11.4477 3 12C3 12.5523 3.44772 13 4 13H17.5858L13.2929 17.2929C12.9024 17.6834 12.9024 18.3166 13.2929 18.7071C13.6834 19.0976 14.3166 19.0976 14.7071 18.7071L20.7071 12.7071C21.0976 12.3166 21.0976 11.6834 20.7071 11.2929L14.7071 5.29289Z" fill={`${Call("/") ? menuBarColor ? "white" : "black" : Call("/home") ? menuBarColor ? "white" : "black" : "black"}`}/>
                     </g>
                   </svg>
                 </div>
               ...
               <div style={{backgroundColor: `${Call("/") ? menuBarColor ? "transparent" : "darkgray" : Call("/home") ? menuBarColor ? "transparent" : "darkgray" : "darkgray"}`}} className="hoverLineBlock">
                 <div style={{backgroundColor: `${Call("/") ? menuBarColor ? "white" : "black" : Call("/home") ? menuBarColor ? "white" : "black" : "black"}`}} className="line"></div>
               </div>
             </Link>
         ...
         <Link style={{
           ...
           backgroundColor: `${Call("/") ? "transparent" : Call("/home") ? "transparent" : "black"}`,
           border         : `${Call("/") ? "1px solid white" : Call("/home") ? "1px solid white" : "none"}`,
         }} onClick={() => {
           window.scrollTo(0, 0);
